...
TEMP_FILE_1 = PATH(tempfile.gettempdir() + "/temp_screen1.png")
...
class SimpleIOSTests(unittest.TestCase):
    ...
    def test_ch_photo(self):
        ...
        sleep(2)
        self.driver.get_screenshot_as_file(TEMP_FILE_1)
        self.a2 = Image.open(TEMP_FILE_1)
